            ...
            <div class="col-12 pageTitle mt-md-5 mt-4">
              <div class="bg-white border p-md-4 p-3">
                 <nav aria-label="breadcrumb" class="breadcrumb-menu">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <h3 class="font-weight-semibold themecolor">{{@$category->title}}</h3></li>
                    <li class="breadcrumb-item mt-2"><a href="#">{{@$sub_category->title}}</a></li>
                              ...
                              <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-4 col-4 pr-2 pl-md-3 car-dealer-img">
                                  <figure class="align-items-center d-flex justify-content-center mb-0 position-relative">
                                    <a href="#" class="d-block"><img src="{{url('public/uploads/ad_pictures/spare-parts-ad/'.@$ad->id.'/'.@$ad->get_one_image->img)}}" class="img-fluid w-100" alt="carish used cars for sale in estonia"></a>
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-8 col-8 car-dealer-list-desc pt-2">
                                  ...
                                  <ul class="list-unstyled mb-0 font-weight-semibold">
                                    <li class="align-items-baseline d-flex"><span class="mr-2">
                                      <p class="serviceprices font-weight-semibold mb-0">
                              <span class="themecolor3 cprice d-inline-block mr-2">€{{$ad->price}}</span>
                              <del>€{{@$ad->price+500}}</del>
                            </p>
                                   
                                    <li class="d-flex"><span class="mr-2"></span>Free Shipping</li>
                                  </ul>
                                </div>
                              </div>
                            </div>
