            ...
            <div class="align-items-md-center row">
              <div class="col-xl-8 col-lg-7 col-sm-6 pr-lg-3 pr-md-0 user-profile">
                <div class="align-items-center d-flex mb-2">
                  ...
                  <span class="badge badge-pill badge-success d-inline-block ml-3 p-1 pl-2 pr-2"><em class="fa fa-check-circle mr-2"></em> {{__('individualProfileView.verified')}} </span>
                </div>
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-8 listingCar-descCar">
                  ...
                  <div class="align-items-center row contactRow " style="">
                    ...
                    <div class="align-items-center col-8 col-lg-7 col-md-7 col-sm-8 d-flex justify-content-end text-right pl-md-3 pl-0">
                      ...
                      @php $id = 'heart'; @endphp
                      @endif
                      <a href="javascript:void(0)" class="saveAd saveAdBtn mr-3" data-id="{{$ad->id}}"><em id="{{@$id}}" class="fa fa-heart"></em>{{ __('individualProfileView.save') }}</span></a>
                      @else
                      @if(@$checkSaved != null)
                      ...
                      <a target="" href="{{url('user/login')}}" class="saveAd saveAdBtn mr-3" data-id="{{$ad->id}}"><em id="{{@$id}}{{$ad->id}}" class="fa fa-heart {{@$id}}"></em> <span class="save_heart">{{__('individualProfileView.save')}}</span></a>
                      @endif
                      <a target="" href="{{url('user/login')}}" class="mr-3" data-id="{{@$ad->id}}"><em class="fa fa-share" style="color: gray"></em> <span class="share_heart">{{__('individualProfileView.share')}}</span></a>
                      @if(Auth::guard('customer')->user())
                      <a data-customer="{{$ad->customer_id}}" data-id="{{$ad->id}}" data-ads_title="{{$ad->title}}" href="javascript:void(0)" class="btn contactbtn themebtn3 show_phone_no send-msg-btn"><em class="fa fa-envelope"></em> {{ __('individualProfileView.sendMessageButton') }}</a>
                      @else
