    ...
    <div class="container pt-2">
        ...
        <div class="row ml-0 mr-0 post-an-ad-row">
            <div class="col-12 bg-white p-md-4 p-3 pb-sm-5 pb-4">
                <h2 style="padding-top:10px" class="border-bottom mx-md-n4 mx-n3 pb-3 px-md-4 px-3 mb-sm-5 mb-4 themecolor">
                    {{__('ads.post_an_ad')}}
                </h2>
                                ...
                                <form action="{{route('post.ad')}}" method="post" id="car_number_form">
                                    ...
                                    <div class="post-ad-auto-bg mt-md-5 mt-4 mx-auto">
                                        <div class="form-group d-flex">
                                            <div class="input-group rounded" id="car_data" style="border: none;">
                                                <span style="background-color: #0072BB;width: 30px;border-top-left-radius: 5px;border-bottom-left-radius: 5px;"></span>
                                                <input type="text" required name="car_number" id="carnumber" value="{{isset($combineArray['car_number']) ? $combineArray['car_number'] : old('car_number')}}" class="border-0 form-control" placeholder="2345IBA" style="border: 1px solid #ccc !important;height: 100%;border-radius: 0px;text-transform: uppercase;">
                                            </div>
                                            <button class="btn rounded-0 themebtn1 px-4 " id='onSubmit' style="background-color: #539200;border-top-right-radius: 5px !important;border-bottom-right-radius: 5px !important;">
        ...
        <div class="row ml-0 mr-0 mt-4 post-an-ad-row mb-4">
            <div class="col-12 bg-white p-md-4 p-3 pb-sm-5 pb-4">

                <form action="{{route('save.ad')}}" method="post" id="myForm" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" id="source" name="source" value="API">
                    <input type="hidden" name="car_number" id="car_number" value="{{isset($combineArray['car_number']) ? $combineArray['car_number'] : old('car_number')}}">
                        ...
                        <div class="vehicleInformation">
                            ...
                            <div class="row">
                                ...
                                <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                    ...
                                    <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                        ...
                                        <div class="col-md-6 col-sm-7">
                                            @if(empty(@$combineArray['make_id']) || empty(@$combineArray['model_id']) || empty(@$combineArray['year']) || empty(@$combineArray['version_id']) )
                                            <input type="text" class="form-control" id="car_info" autocomplete="off" placeholder="{{__('common.make_model_year_version')}}" data-toggle="modal" name="car_info" data-target="#postedcarinfo" data-parsley-error-message="Please Provide Car Info" data-parsley-required="true" data-parsley-trigger="change">
                                            @else
                                            @php
                                            $version =
                                            $combineArray['make'].'/'.$combineArray['model'].'/'.$combineArray['year'].'/';
                                            $version .= $combineArray['cc'].' L ';
                                            $version .= $combineArray['enginPower'].' KW';
                                            @endphp
                                            <input type="text" class="form-control" id="car_info" autocomplete="off" placeholder="{{__('common.make_model_year_version')}}" data-toggle="modal" name="car_info" data-target="#postedcarinfo" data-parsley-error-message="Please Provide Car Info" data-parsley-required="true" data-parsley-trigger="change" value="{{isset($version) ? $version : old('car_info')}}">
                                            @endif
                                            <input type="hidden" id="maker" name="make_id" value="{{isset($combineArray['make_id']) ? $combineArray['make_id'] : old('make_id')}}" required>
                                            <input type="hidden" id="maker_title" name="make" value="{{isset($combineArray['make']) ? $combineArray['make'] : old('make')}}" required>
                                            <input type="hidden" id="model" name="model_id" value="{{isset($combineArray['model_id']) ? $combineArray['model_id'] : old('model_id')}}" required>
                                            <input type="hidden" id="model_title" name="model" value="{{isset($combineArray['model']) ? $combineArray['model'] : old('model')}}" required>
                                            <input type="hidden" id="year" name="year" value="{{isset($combineArray['year']) ? $combineArray['year'] : old('year')}}" required>
                                            <input type="hidden" id="version" name="version_id" value="{{isset($combineArray['version_id']) ? $combineArray['version_id'] : old('version_id')}}" required>
                                            <input type="hidden" id="version_title" name="version" value="{{isset($combineArray['version']) ? $combineArray['version'] : old('version')}}" required>
                                            <input type="hidden" name="length" value="{{isset($combineArray['length']) ? $combineArray['length'] : old('length')}}">
                                            <input type="hidden" name="width" value="{{isset($combineArray['width']) ? $combineArray['width'] : old('width')}}">
                                            <input type="hidden" name="height" value="{{isset($combineArray['height']) ? $combineArray['height'] : old('height')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                        ...
                                        <div class="col-md-6 col-sm-7">
                                            <select class="form-control" id="body_type_id" name="body_type_id">
                                                ...
                                                <option value="{{$bodyType->body_type_id}}" @if((isset($combineArray['body_type_id']) && @$combineArray['body_type_id']==$bodyType->body_type_id) ||
                                                    old('body_type_id') == $bodyType->body_type_id) selected
                                    ...
                                    <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                        ...
                                        <div class="col-md-6 col-sm-7">
                                            <select class="form-control" id="doors" name="doors" data-parsley-error-message="Please select doors" data-parsley-required="true" data-parsley-trigger="change">
                                                <option value="">{{__('ads.select_one')}}</option>
                                                <option value="2" @if((isset($combineArray['number_of_door']) && @$combineArray['number_of_door']==2) || old('doors')==2) selected @endif>2</option>
                                                <option value="3" @if((isset($combineArray['number_of_door']) && @$combineArray['number_of_door']==3) || old('doors')==3) selected @endif>3</option>
                                                <option value="4" @if((isset($combineArray['number_of_door']) && @$combineArray['number_of_door']==4) || old('doors')==4) selected @endif>4</option>
                                                <option value="5" @if((isset($combineArray['number_of_door']) && @$combineArray['number_of_door']==5) || old('doors')==5) selected @endif>5</option>
                                            </select>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="row car-list-row" id="make_years">
                                                        ...
                                                        <div class="col-md-3 col-sm-12 car-info-list-col modal-list-col" style="display: none">
                                                            <h6 class="post-ad-modal-title d-flex align-items-center mb-4">
                                                                ...
                                                                {{__('common.modal')}}<br><span id="model_value_selected"></span>
                                                            </h6>
                                                        ...
                                                        <div class="col-md-3 col-sm-12 car-info-list-col modal-year-col" style="display: none">
                                                            <h6 class="post-ad-modal-title d-flex align-items-center mb-4" class="post-ad-modal-title"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em>{{__('common.modal')}}
                                                                {{__('common.year')}}<br><span id="year_selected"></span>
                                                            </h6>
                                                            <div class="post-modal-list">
                                    ...
                                    <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                        ...
                                        <div class="col-md-6 col-sm-7">
                                            ...
                                            <input type="number" pattern="[0-9]+([,\.][0-9]+)?" step="0.01" class="form-control" placeholder="e.g 5000" data-parsley-error-message="Enter valid mileage (1-1000000)" data-parsley-required="true" data-parsley-trigger="change" name="millage" value="{{isset($combineArray['milleage']) ? $combineArray['milleage'] : old('millage')}}">
                                        </div>
                                    </div>
                                    <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                        <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                                        ...
                                        <div class="col-md-6 col-sm-7">
                                            <select class="form-control" id="color" name="color">
                                                ...
                                                <option value="{{$color->color_id}}" @if(old('color')==$color->color_id
                                                    || @$combineArray['color_name'] == $color->name) {{ 'selected' }}
                                    ...
                                    <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                        ...
                                        <div class="col-md-6 col-sm-7">
                                            ...
                                            <input class="form-control" type="number" placeholder="e.g 6.7" step="0.01" name="fuel_average" id="fuel_average" value="{{isset($combineArray['fuel_average']) ? $combineArray['fuel_average'] : old('fuel_average')}}">
                                    ...
                                    <div class="form-group mb-4 row">
                                        ...
                                        <div class="col-md-6 col-sm-7">
                                            <input class="form-control" type="number" placeholder="{{__('common.price')}}" name="price" id="price" value="{{old('price')}}" onkeydown="javascript: return event.keyCode == 69 ? false : true">
                                            <div class="pricecheckboxes mt-3">
                                                <div class="custom-control custom-checkbox mt-2">
                                                    <input type="checkbox" class="custom-control-input" id="pricecheck1" name="vat" value="customEx" 
                                                    {{old('vat') !=null ? 'checked' :''}}>
                                                    <label class="custom-control-label" for="pricecheck1">{{__('common.incl_20_vat')}}</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mt-2">
                                                    <input type="checkbox" class="custom-control-input" id="pricecheck2" name="neg" value="customEx" 
                                                    {{old('neg')!=null ? 'checked' :''}}>
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="col-lg-6 col-md-8 col-12">
                                    ...
                                    if(!empty($combineArray['next_inspection'])){
                                    $description = $combineArray['next_inspection'];
                                    }
                                    @endphp
                                    <textarea id="description" class="form-control" rows="6" name="description"> {{old('description') != null ? old('description') : $description}}</textarea>
  ...
  transition: all 1s linear 0s;overflow: hidden;">
                        ...
                        <div class="additional-info">
                            ...
                            <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                ...
                                <div class="col-md-6 col-lg-5 col-sm-7">
                                    <input type="text" class="form-control" readonly name="engine_capacity" id="engine_capacity" placeholder="Engine Capacity* (cc)" value="{{isset($combineArray['cc']) ? $combineArray['cc'] : old('cc')}}">
                                </div>
                            </div>
                            <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                <div class="col-md-4 col-sm-3 mb-1 text-sm-right">
                                ...
                                <div class="col-md-6 col-lg-5 col-sm-7">
                                    <input type="text" class="form-control" readonly name="engine_power" id="engine_power" placeholder="engine power (KW)" value="{{isset($combineArray['enginPower']) ? $combineArray['enginPower'] : old('engine_power')}}">
                                </div>
                            </div>
                            <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                <div class="col-md-4 col-sm-3 mb-1 text-sm-right">
                                ...
                                <div class="col-md-6 col-lg-5 col-sm-7">
                                    <select @if(isset($combineArray['fuel_type']) && !empty($combineArray['fuel_type'])) @endif name="fuel_type" id="fuel_type" class="form-control">
                                        @foreach($engineTypes as $engineType)
                                        <option value="{{$engineType->engine_type_id}}" @if(old('fuel_type')==$engineType->engine_type_id ||
                                            @$combineArray['fuel_type'] == $engineType->engine_type_id) {{ 'selected' }}
                                            @endif>{{$engineType->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                ...
                                <div class="col-md-6 col-lg-5 col-sm-7">
                                    <select name="transmission_type" id="transmission_type" class="form-control">
                                        ...
                                        <option value="{{$transmission->transmission_id}}" @if(old('transmission_type')==$transmission->transmission_id ||
                                            @$combineArray['transmission_type'] == $transmission->transmission_id)
                                            {{ 'selected' }} @endif>{{$transmission->title}}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-6 form-group mb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="featurecheck-{{$feature->feature_id}}" name="features[]" value="{{$feature->feature_id}}">
                                                <label class="custom-control-label font-weight-semibold" for="featurecheck-{{$feature->feature_id}}">{{$feature->name}}</label>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                ...
                {{__('ads.can_select_multiple')}}<br><br> -->
                                            ...
                                            <div style="text-align: left;" class="d-none main_cover_photo">
                                                <span style="position: absolute;z-index: 1000;margin-left: 10px;margin-top: 17px;color: white;font-weight: bold;">Main
                                                    Cover Photo</span>
                                            </div>
                            ...
                            <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                ...
                                <div class="col-lg-4 col-sm-6 col-sm-7">
                                    <div class="input-group">
                                        ...
                                        @if($customerDetail->customer_firstname !='' &&
                                        $customerDetail->customer_lastname !='')
        ...
        success: function(data) { 
            ...
            if (data['status'] == 'success') {
                ...
                $.each(data['data'], function(index, value) {
                    $("#car_data").append(
                        '<input type="hidden" name="car_data[' +
                        index + ']" value="' + value + '">');
                }); // END FOR EACH
...
$(document).ready(function() {
    ...
    method: "get",
    success: function(data) {
        $('.make-list-col').addClass('car-list-active');
        ...
        if($('#maker').val() != '')
        {
            loadModels($('#maker').val());
            $('.make-list-col').removeClass('car-list-active').addClass('prev-list-active');
            $('.modal-list-col').css('display', 'block').addClass('car-list-active');
        }

        if($('#model').val() !='')
        {

        $("#model_" + $('#model').val()).addClass('list-active');
        ...
        if($('#year').val() != '')
        {
        $("#" + $('#year').val()).addClass("list-active");
        $('#year_selected').html('(' + $('#year').val() + ')');

        loadVersions($('#model').val(),$('#year').val());
        }

        if($('#version').val() !='')
        {
        $('#version_'+$('#version').val()).addClass('list-active');
        }
    }
    }).done(function() {
    });
