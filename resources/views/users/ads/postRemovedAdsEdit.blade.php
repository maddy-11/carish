              ...
              <div class="col-md-12 text-center">
                ...
                <div class="desc"><p class="text-center">or drag to box</p></div> -->
                      <div class="upload-note mt-0 mb-2">
                        <!--  {{__('postCarAdPage.photo_extentions')}}
                <br>
            ...
            <div class="modal-content">
                ...
                <form class="featured_request_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <p style="font-style: italic;font-weight: 400;color: red;padding-left: 35px;">{{__('featureAdPopup.message')}}</p>
                        </div>
                        ...
                        <div style="display:block;padding-left: 20px;">
                            ...
                            <span class="ml-2">{{__('featureAdPopup.useAccountBalance')}}</span>
                        </div>
                        @endif
                        ...
                        <div class="ad" style="padding: 0 20px;box-shadow: 0px 5px 0px 0px rgba('0,0,0,0.25');">
                            <div class="input-group" id="car_data" style="border: none;margin-top: 40px;margin-left: 30%;">
                                <span style="background-color: white;width: 30%;border-top-left-radius: 5px;border-bottom-left-radius: 5px;border: 1px solid #aaa;border-right: none;padding-left: 5px;line-height: 2;font-weight: 600;" class="feature_span">{{__('featureAdPopup.featureThisAdFor')}} </span>
                        ...
                        <div class="modal-footer" style="justify-content: center;border-top: none;">
                            <button data-dismiss="modal" aria-label="Close" type="button" class="btn btn-danger discard_ad" data-id="{{@$adsDetails->id}}" style="background-color: #eeefff;border: 1px solid #ccc;color: black;">{{__('featureAdPopup.exitButtonText')}}</button>
