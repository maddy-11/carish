...
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">
   ...
   <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Car Data</h3>
  </div>
    ...
    <div class="bg-white custompadding customborder">
      ...
      <div class="table-responsive">
        <table   class="table table-bordered" style="width:100%">
          ...
          <tbody>
          @if(@$carData != null)
          @if(@$carData['status'] == 'success')
          @foreach($carData['data'] as $index => $data)
                <tr>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">   
      <!-- Modal content-->
    <form action="{{url('admin/get-cardata')}}" method="POST" enctype="multipart/form-data">
