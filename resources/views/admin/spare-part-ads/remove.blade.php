...
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">
   ...
   <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Spare Part Ads / <a target="" href="{{url('admin/romoved-part-ads')}}">Removed</a></h3>
  </div>
  <div class="col-lg-4 col-md-5 col-sm-5 search-col text-right">
    ...
    <button type="button" class="btn btn-warning" id="soldout">SoldOut</button>
    <button type="button" class="btn btn-danger" id="reject">Rejected</button> -->
    <button type="button" name="bulk_delete" id="bulk_delete" class="btn btn-danger">Delete SpareParts</button>
  </div>
</div>
...
<div class="row">
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        @elseif($ad->status == 2)
                            ...
                            &nbsp;&nbsp;
                             <!-- <a  class="fa fa-eye" href="{{url('admin/removed-part-ad-detail/'.$ad->id)}}" ><i  title="View Add"></i></a> -->
 ...
 $('#bulk_delete').on('click', function(){
        ...
        swal({
          title: "Alert!",
          text: "Are you sure you want to Delete SpareParts?",
          type: "info",
          showCancelButton: true,
          confirmButtonClass: "btn-danger",
          confirmButtonText: "Yes!",
         ...
         function(isConfirm) {
           if (isConfirm){
            ...
            {
                $.ajax({
                    url:"{{url('admin/allDelete-removedPartAd-model')}}",
                    method:"get",
                    data:{id:id},
                    success:function(data)
                    {
