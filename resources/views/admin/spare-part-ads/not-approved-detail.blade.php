...
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">
  ...
  <div class="col-lg-8 col-md-7 col-sm-7  title-col">
     <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Spare Part Ads / <a target="" href="{{url('admin/not-approved-sp-ads')}}">Not Approved</a> / <a target="" href="{{url('admin/not-approved-part-ad-detail/'.@$ads->id)}}">{{@$ads->title}}</a></h3>
        ...
        <div class="bg-white custompadding customborder h-100 d-flex flex-column">
            ...
            <div class="col-sm-8 col-9">
                    ...
                    <div class="row mt-3 dr-detail-row">
                        ...
                        <div class="col-md-6 col-6 mb-3 dr-detail-col">
                            <h6 class="text-capitalize font-weight-bold mb-1">Poster Name:</h6>
                            <p class="mb-0">{{ @$ads->poster_name }}</p>
                        </div>
                        <div class="col-md-6 col-6 mb-3 dr-detail-col">
      ...
      <div class="col-4 col-md-4 dr-personal-prof mb-4">
        <div class="bg-white custompadding customborder h-100 d-flex flex-column">
          ...
          <div class=" personal-profile pr-0 pr-sm-3">
            {{ @$ads->get_sp_ad_description($ads->id , $language->id)->description }}
          </div>
          </div> 
      </div>
    @endforeach
