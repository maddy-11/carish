...
@section('content')
<!-- <div class="row">
    <h2 class="text-info">Active SpareParts</h2>
</div> -->
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">

   <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Spare Part Ads / <a target="" href="{{url('admin/active-part-ads')}}">Active </a></h3>
  </div>
  ...
  <div class="col-lg-12 col-12 appointment-col">
    <div class="bg-white custompadding customborder">
      <div class="section-header">
       <h5 class="mb-1">Active SparePart Ads</h5>
      </div>
            ...
            @foreach($ads as $ad)
                <tr>
                    <!-- <td>
                        ...
                        <a  class="fa fa-eye" href="{{url('admin/active-part-ad-detail/'.$ad->id)}}" ><i title="View Add"></i></a>
