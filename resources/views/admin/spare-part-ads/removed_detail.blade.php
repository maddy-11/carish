...
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">
  ...
  <div class="col-lg-8 col-md-7 col-sm-7  title-col">
     <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Spare Part Ads / <a target="" href="{{url('admin/removed-part-ads')}}">Removed</a> / <a target="" href="{{url('admin/removed-part-ad-detail/'.@$ads->id)}}">{{@$ads->title}}</a></h3>
