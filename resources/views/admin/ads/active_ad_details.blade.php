...
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">
  ...
  <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Car Ads / <a target="" href="{{url('admin/active-ads')}}">Active</a> / <a target="" href="{{url('admin/active-ad-details/'.@$ads->id)}}">{{@$ads_maker->title}}-{{@$ads_model->name}}&nbsp;{{@$ads->year}}</a></h3>
  ...
  <div class="col-lg-4 col-md-5 col-sm-5 search-col text-right">
   <a class="btn btn-primary" href="{{ url()->previous() }}">
    ...
    <!--   @if($ads->is_featured == 'true')
      <button type="button" class="btn btn-info" id="unFeatured" data-id="{{$ads->id}}">Un-Featured</button>
      @elseif($ads->is_featured == 'false')
      <button type="button" class="btn btn-warning" id="featured" data-id="{{$ads->id}}">Featured</button>
    @endif -->
...
<div class="row">
    ...
    <!--     <div class="col-md-4 col-6  productImgCol">
    <div class="bg-white p-2 border h-100">
      <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
         @foreach(@$ads_images as $ad_image)
        <li class="position-relative overflow-hidden rounded car_gallery" data-thumb="{{asset('public/uploads/ad_pictures/cars/'.$ads->id.'/'.$ad_image->img)}}" data-src="{{asset('public/uploads/ad_pictures/cars/'.$ads->id.'/'.$ad_image->img)}}">
          ...
          <img src="{{asset('public/uploads/ad_pictures/cars/'.$ads->id.'/'.$ad_image->img)}}" class="img-fluid" style="width:100%;height: 450px;">
        </li>
        @endforeach
      </ul>
    </div>
...
<div class="bg-white custompadding customborder d-flex flex-column">
          <div class="section-header">
              <h5 class="mb-1 text-capitalize"> Version Detail</h5>
          </div>
<div class="row">
<div class="col-12">
  <table width="100%" class="version_detail">
      <tr>
      ...
      <div class="col-4 col-md-4 dr-personal-prof mb-4">
        <div class="bg-white custompadding customborder h-100 d-flex flex-column">
          ...
          <div class=" personal-profile pr-0 pr-sm-3">
            {{-- {{ @$ads->get_ad_description($ads->id , $language->id)->description }} --}}
