             ...
             @foreach($customers_accounts as $invoice)
              <tr>
               ...
               <td class="text-center">
                ...
                <td>
                  <span style="color: green;">+ €{{@$invoice->paid_amount != null ? @$invoice->paid_amount : (@$invoice->credit != null ? @$invoice->credit : @$invoice->debit)}}
                    </span>
                </td>
                <td>
...
swal({
title: "Alert!",
text: "Are you sure you want to Delete UnPaid Invoices?",
type: "info",
showCancelButton: true,
