...
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">
  ...
  <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Offer Services / <a target="" href="{{url('admin/pending-services')}}">Pending</a> / <a target="" href="{{url('admin/pending-service-details/'.@$service->id)}}">{{@$service->primary_service->title}}</a></h3>
  ...
  @if($service->status == 1)
  <div class="col-lg-8 col-md-7 col-sm-7  title-col">
   <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Offer Services / <a target="" href="{{url('admin/active-services')}}">Active</a> / <a target="" href="{{url('admin/pending-service-details/'.@$service->id)}}">{{@$service->primary_service->title}}</a></h3>
  ...
  @if($service->status == 2)
    <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Offer Services / <a target="" href="{{url('admin/removed-services')}}">Removed</a> / <a target="" href="{{url('admin/pending-service-details/'.@$service->id)}}">{{@$service->primary_service->title}}</a></h3>
  ...
  @if($service->status == 3)
    <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Offer Services / <a target="" href="{{url('admin/not-approved-services')}}">Not Approved</a> / <a target="" href="{{url('admin/pending-service-details/'.@$service->id)}}">{{@$service->primary_service->title}}</a></h3>
...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 search-col text-right">
    ...
    <button class="btn btn-success" id="service_detail" > {{__('search.save')}}</button>
</div>
</div>
