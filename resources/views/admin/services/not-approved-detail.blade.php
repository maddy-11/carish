...
<div class="bg-white main-titl-row  pb-3 pt-3 row align-items-center ">
  ...
  <div class="col-lg-8 col-md-7 col-sm-7  title-col">
    <h3 class="fontbold maintitle mb-2 mb-sm-0 text-capitalize">Offer Services / <a target="" href="{{url('admin/not-approved-services')}}">Not Approved</a> / <a target="" href="{{url('admin/not-approved-service-details/'.@$service->id)}}">{{@$service->primary_service->title}}</a></h3>
