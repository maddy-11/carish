        ...
        <table class="table table-bordered" id="myTable" style="width:100%">
          ...
          <tbody>
             @foreach($customers_accounts as $invoice)
              <tr>
                <td><input type="checkbox" name="account_checkbox[]" class="account_checkbox" value="{{$invoice->id}}" />
               ...
               <td class="text-center">
                ...
                <td>
                  <span style="color: green;">+ €{{@$invoice->paid_amount != 0.00 ? @$invoice->paid_amount : (@$invoice->credit != 0.00 ? @$invoice->credit : @$invoice->debit)}}
                    </span>
                </td>
                <td>
                ...
                <td>{{@$invoice->approved_date != null ? @Carbon::parse(@$invoice->approved_date)->format('d-M-Y') : '--'}}</td>
              </tr>
            @endforeach
          </tbody>
      </table>
