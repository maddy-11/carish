...
class CreateUpdateModels extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'makemodels:createmodels';
     ...
     * @var string
     */
    protected $description = 'this command create/updates models tabel car_model';
            ...
            if ($fp) {
                ...
                while (!feof($fp)) {
                    if (!$ignoreFirst) {
                        ...
                        if (!empty($fields) && !empty($fields[0]) && str_replace("'", "", $fields[2]) != 'name') {
                            if (str_replace("'", "", $fields[5]) == '1' || str_replace("'", "", $fields[5]) == 1) {

                                DB::table('car_model')
                                    ->updateOrInsert(
                                        [
                                            'id_car_model' => str_replace("'", "", $fields[0])
                                        ],
                                        [
                                            'id_car_make' => str_replace("'", "", $fields[1]),
